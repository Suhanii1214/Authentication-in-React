        ...
        <div className={`${styles.glass} ${extend.glass}`} style={{width: "45%"}}>
          ...
          <form className='py-1' onSubmit={formik.handleSubmit}>
              ...
              <div className="textbox flex flex-col items-center gap-6">
                ...
                <div className='name flex w-3/4 gap-10'>
                  <input {...formik.getFieldProps('contact')} className={`${styles.textbox} ${extend.textbox}`} type="text" placeholder='Contact No.' />
                  <input {...formik.getFieldProps('email')} className={`${styles.textbox} ${extend.textbox}`} type="text" placeholder='Email' />
                </div>

                <textarea {...formik.getFieldProps('adress')} className={`${styles.textbox} ${extend.textbox}`} type="text" placeholder='Address' />
